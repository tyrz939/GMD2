...
if (argument_count != 9) return lua_show_error("d3d_addFloor: Expected 9 arguments, got " + string(argument_count));

d3d_addFloor(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8);