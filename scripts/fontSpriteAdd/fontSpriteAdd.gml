/// @function LoadQueueAddSpriteFont
/// @description LoadQueueAddSpriteFont
/// @param {real} file
/// @param {real} firstChar
...
var file = argument0, firstChar = argument1, prop = argument2, space = argument3,
...
var fnt = font_add_sprite(spr, firstChar, prop, space)
