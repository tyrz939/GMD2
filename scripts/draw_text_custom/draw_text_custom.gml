...
while(string_length(_strab)>0)
{
       ...
       */
       ...
       if string_copy(str_color[i],0,3) = "rgb" or string_copy(str_color[i],0,14) = "make_color_rgb"{
            ...
            draw_line_width(_x+str_length,_y+str_height+string_height(string(str_part[i]))+v1,_x+str_length+string_width(string(str_part[i])),_y+str_height+string_height(string(str_part[i]))+v1,v2)
       ...
       draw_text_transformed(_x+str_length,_y+str_height,string(str_part[i]),_xscale,_yscale,0)
       str_length += string_width(string(str_part[i]))
       _str += str_part[i]
       if str_check{
          str_length = 0 
          str_height += string_height(string("A"))
       }       
i++
};
